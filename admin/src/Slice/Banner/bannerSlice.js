...
export const addBanner = createAsyncThunk('banner/addBanner', async (formData, { rejectWithValue }) => {
  try {
    const response = await axios.post('https://api.maasavitrinursingcollege.com/api/banner', formData);
...
export const fetchBanners = createAsyncThunk('banner/fetchBanners', async (_, { rejectWithValue }) => {
  try {
    const response = await axios.get('https://api.maasavitrinursingcollege.com/api/banner');
...
export const fetchBanner = createAsyncThunk('banner/fetchBanner', async (id, { rejectWithValue }) => {
  try {
    const response = await axios.get(`https://api.maasavitrinursingcollege.com/api/banner/${id}`);
...
export const updateBanner = createAsyncThunk('banner/updateBanner', async ({ id, formData }, { rejectWithValue }) => {
  try {
    const response = await axios.put(`https://api.maasavitrinursingcollege.com/api/banner/${id}`, formData);
    return response.data.data;
  } catch (error) {
    return rejectWithValue(error.response.data);
  }
...
export const deleteBanner = createAsyncThunk('banner/deleteBanner', async (id, { rejectWithValue }) => {
  try {
    const response = await axios.delete(`https://api.maasavitrinursingcollege.com/api/banner/${id}`);
