...
const EditTag = () => {
  ...
  const getCategoryData = async () => {
    try {
      const res = await axios.get("https://api.maasavitrinursingcollege.com/api/category");
  ...
  const getApiData = async () => {
    try {
      let res = await axios.get("https://api.maasavitrinursingcollege.com/api/subcategory/" + _id);
  ...
  const postData = async (e) => {
    ...
    try {
      let res = await axios.put(
        "https://api.maasavitrinursingcollege.com/api/subcategory/" + _id,
        formdata
      );
      if (res.status === 200) {
