...
const AllTags = () => {
    ...
    const getApiData = async () => {
        try {
            let res = await axios.get("https://api.maasavitrinursingcollege.com/api/subcategory");
    ...
    const deleteRecord = async (_id) => {
        try {
            let res = await axios.delete("https://api.maasavitrinursingcollege.com/api/subcategory/" + _id);
            if (res.status === 200) {
